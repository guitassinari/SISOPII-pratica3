...
#define SOAP_TYPE_ns__mulResponse (13)
/* ns:mulResponse */
...
public:
	double *result;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:double */
public:
	int soap_type() const { return 13; } /* = unique id SOAP_TYPE_ns__mulResponse */
};
#endif

#ifndef SOAP_TYPE_ns__mul
#define SOAP_TYPE_ns__mul (14)
/* ns:mul */
struct ns__mul
{
public:
	...
	double b;	/* required element of type xsd:double */
public:
	int soap_type() const { return 14; } /* = unique id SOAP_TYPE_ns__mul */
};
#endif

#ifndef SOAP_TYPE_ns__subResponse
#define SOAP_TYPE_ns__subResponse (16)
/* ns:subResponse */
...
public:
	double *result;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of type xsd:double */
public:
	int soap_type() const { return 16; } /* = unique id SOAP_TYPE_ns__subResponse */
};
#endif

#ifndef SOAP_TYPE_ns__sub
#define SOAP_TYPE_ns__sub (17)
/* ns:sub */
struct ns__sub
{
public:
	...
	double b;	/* required element of type xsd:double */
public:
	int soap_type() const { return 17; } /* = unique id SOAP_TYPE_ns__sub */
};
#endif
